				...
				<div class="row gx-5">
					...
					<div class="col-lg-9">
						...
						<article>
							...
							<header class="mb-4">
								<!-- Post title-->
								<h1 class="fw-bolder mb-1">${list[0].even_name}</h1>
								<!-- Post meta content-->
								<div class="text-muted fst-italic mb-2">${list[0].even_start_date}</div>
								<!-- Post categories-->
							...
							<!-- Post content-->
							<section class="mb-5">
								<p class="fs-5 mb-4">${list[0].even_desc}</p>
						...
						<article>
							...
							<header class="mb-4">
								<!-- Post title-->
								<h1 class="fw-bolder mb-1">${list[1].even_name}</h1>
								<!-- Post meta content-->
								<div class="text-muted fst-italic mb-2">${list[1].even_start_date}</div>
								<!-- Post categories-->
								<a class="badge bg-secondary text-decoration-none link-light"
									href="#!">공지사항</a> <a
									class="badge bg-secondary text-decoration-none link-light"
							...
							<!-- Post content-->
							<section class="mb-5">
								<p class="fs-5 mb-4">${list[1].even_desc}</p>
								<!-- <p class="fs-5 mb-4">The universe is large and old, and the ingredients for life as we know it are everywhere, so there's no reason to think that Earth would be unique in that regard. Whether of not the life became intelligent is a different question, and we'll see if we find that.</p>
                                    <p class="fs-5 mb-4">If you get asteroids about a kilometer in size, those are large enough and carry enough energy into our system to disrupt transportation, communication, the food chains, and that can be a really bad day on Earth.</p>
                                    <h2 class="fw-bolder mb-4 mt-5">I have odd cosmic thoughts every day</h2>
                                    <p class="fs-5 mb-4">For me, the most fascinating interface is Twitter. I have odd cosmic thoughts every day and I realized I could hold them to myself or share them with people who might be interested.</p>
						...
						<article>
							...
							<header class="mb-4">
								<!-- Post title-->
								<h1 class="fw-bolder mb-1">${list[2].even_name}</h1>
								<!-- Post meta content-->
								<div class="text-muted fst-italic mb-2">${list[2].even_start_date}</div>
								<!-- Post categories-->
								<a class="badge bg-secondary text-decoration-none link-light"
									href="#!">공지사항</a> <a
									class="badge bg-secondary text-decoration-none link-light"
							...
							<!-- Post content-->
							<section class="mb-5">
								<p class="fs-5 mb-4">${list[2].even_desc}</p>
								<!-- <p class="fs-5 mb-4">The universe is large and old, and the ingredients for life as we know it are everywhere, so there's no reason to think that Earth would be unique in that regard. Whether of not the life became intelligent is a different question, and we'll see if we find that.</p>
                                    <p class="fs-5 mb-4">If you get asteroids about a kilometer in size, those are large enough and carry enough energy into our system to disrupt transportation, communication, the food chains, and that can be a really bad day on Earth.</p>
                                    <h2 class="fw-bolder mb-4 mt-5">I have odd cosmic thoughts every day</h2>
                                    <p class="fs-5 mb-4">For me, the most fascinating interface is Twitter. I have odd cosmic thoughts every day and I realized I could hold them to myself or share them with people who might be interested.</p>
