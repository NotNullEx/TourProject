...
function tour_insert(){
	var formData = $("form[name=input]").serialize();
	$.ajax({
		type : "POST",
		url : "/admin/insTourData",
		data : formData,
...
<section class="bg-light py-5">
	<div class="container px-5 my-5">
		<div class="text-center mb-5">
			<h1 class="fw-bolder">관광지 데이터 등록</h1>
		</div>
	</div>
				...
				<div
					...
					<form name="input">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="tour_post_sn" name="tour_post_sn">
						</div>
						<div class="mb-3">
							<label for="id" class="form-label float-start">관광지 명</label> 
							<input type="text" class="form-control" id="tour_post_sj" name="tour_post_sj" aria-describedby="emailHelp">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">fax 번호</label>
							<input type="text" class="form-control" id="tour_cmmn_fax" name="tour_cmmn_fax">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label class="form-label float-start">교통정보</label> <input
								type="text" class="form-control" id="tour_subway_info" name="tour_subway_info" aria-describedby="emailHelp">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">홈페이지 url</label>
							<input type="text" class="form-control" id="tour_cmmn_hmpg_url" name="tour_cmmn_hmpg_url">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">기관 연락처</label>
							<input type="text" class="form-control" id="tour_cmmn_telno" name="tour_cmmn_telno">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">운영요일</label>
							<input type="text" class="form-control" id="tour_cmmn_bsnde" name="tour_cmmn_bsnde">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">장애인 편의시설</label>
							<input type="text" class="form-control" id="tour_bf_desc" name="tour_bf_desc">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">휴무일</label>
							<input type="text" class="form-control" id="tour_cmmn_rstde" name="tour_cmmn_rstde">
						</div>
						<div class="mb-3">
							<label class="float-start form-label">운영 시간</label>
							<input type="text" class="form-control" id="tour_cmmn_use_time" name="tour_cmmn_use_time">
						</div>
						
						<button type="button" id="signIn" class="w-100 btn btn-primary mb-2" onclick="tour_insert()">등록</button>
